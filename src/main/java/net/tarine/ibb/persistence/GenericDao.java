...
//	private static final Logger LOG = Logger.getLogger(GenericDao.class);
	...
	public static void updateGeneric(Session ses, Serializable key, Object instance) throws SystemException {
	...
	public static Serializable saveGeneric(Session ses, Object transientInstance) throws SystemException {
		try {
	...
	public static void deleteGeneric(Session ses, Serializable id, Object instance) throws SystemException {
		try {
		...
		throw new SystemException("Delete: id is not Integer nor String type");
	}

	@SuppressWarnings("unchecked")
	public static <S> S findById(Session ses, Class<S> findClass, Serializable key) throws SystemException {
		try {
	...
	@SuppressWarnings("unchecked")
	public static <S> List<S> findByProperty(Session ses, Class<S> findClass, String propertyName, Object value) throws SystemException {
		try {
			List<S> listS = null;
	...
	@SuppressWarnings("unchecked")
	public static <S> List<S> findByClass(Session ses, Class<S> findClass, String orderProperty) throws SystemException {
		try {
			List<S> listS = null;
